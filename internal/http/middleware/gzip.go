...
type GzipConfigInterface interface {
...
func NewGzipMiddleware(gzipConfigInterface GzipConfigInterface) Middleware {
	return func(next http.HandlerFunc) http.HandlerFunc {
		return func(res http.ResponseWriter, req *http.Request) {
			gzipDisabled, err := gzipConfigInterface.GetGZipDisabled()
			if err != nil {
