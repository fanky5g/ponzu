...
func (s *Service) SetCredential(userId string, credential *Credential) error {
	...
	case CredentialTypePassword:
		...
		hashedCredential := &CredentialHash{
			UserId: userId,
...
func (s *Service) VerifyCredential(userId string, credential *Credential) error {
	...
	hashedCredential := c.(*CredentialHash)
	switch credential.Type {
	case CredentialTypePassword:
